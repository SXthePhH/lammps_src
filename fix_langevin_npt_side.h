#ifdef FIX_CLASS
// clang-format off
FixStyle(npt_langevin_side,FixNPTLangevinSide);
// clang-format on
#else

#ifndef LMP_FIX_NPT_LANGEVIN_SIDE_H
#define LMP_FIX_NPT_LANGEVIN_SIDE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixNPTLangevinSide : public Fix {
 public:
  FixNPTLangevinSide(class LAMMPS *, int, char **);
  ~FixNPTLangevinSide() override;
