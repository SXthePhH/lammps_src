...
void FixNH::initial_integrate(int /*vflag*/)
{
  ...
  // if (pstat_flag && mpchain) nhc_press_integrate_me();
...
void FixNH::nhc_press_integrate_me()
{
  int ich,i,pdof;
